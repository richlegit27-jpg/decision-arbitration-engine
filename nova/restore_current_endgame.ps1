...
# 1ï¸âƒ£ Backup current Nova folder
...
# 2ï¸âƒ£ Restore current local files (HTML, CSS, JS)
...
Write-Host "âœ… Nova UI restored using current local files!"
Write-Host "Restart your server now â€” UI should be fully functional and polished."
