...
def test_mobile_sync_with_attachments():
    session_id = f"pytest_mobile_{uuid.uuid4().hex}"
    upload_name = f"pytest_mobile_file_{uuid.uuid4().hex}.txt"
    ...
    try:
        ...
        # Simulate mobile chat using uploaded attachment
        ...
        # Check session attachment injection
