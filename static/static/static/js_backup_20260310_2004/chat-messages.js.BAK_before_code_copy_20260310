...
function renderMessage(message, index){
  ...
  const retryText = escapeHtml(message?.content || "")

  const actionsHtml = role === "assistant"
    ? `
      <div class="message-actions">
        <button type="button" class="message-action-btn" data-copy-message="${messageId}">Copy</button>
        <button type="button" class="message-action-btn" data-retry-message="${retryText}">Regenerate</button>
    ...
    : `
      <div class="message-actions">
        <button type="button" class="message-action-btn" data-copy-message="${messageId}">Copy</button>
        <button type="button" class="message-action-btn" data-retry-message="${retryText}">Reply</button>
        <button type="button" class="message-action-btn" data-delete-message="${messageId}">Delete</button>
      </div>
    `
...
function renderMessages(){
  ...
  el.messages.innerHTML = messages.map(renderMessage).join("")
  updateJumpButton()
}
