(function () {
    ...
    function installCoreListeners() {
        ...
        if (window.stopSpeechBtn) {
            window.stopSpeechBtn.addEventListener("click", function () {
                window.speechSynthesis.cancel();
                setStopSpeechActive(false);

                if (window.ttsBtn) {
                    window.ttsBtn.classList.remove("speaking");
                }
        ...
        if (window.voiceBtn && window.NovaMobileVoice) {
            window.voiceBtn.addEventListener("click", async function () {
                window.voiceBtn.classList.add("recording");
