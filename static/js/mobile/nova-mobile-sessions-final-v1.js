(function () {
    ...
    var MARKER = "__NOVA_MOBILE_SESSIONS_FINAL_V1_20260704__";
    ...
    var PANEL_ID = "nova-mobile-sessions-final-panel-v1";
    var BACKDROP_ID = "nova-mobile-sessions-final-backdrop-v1";
    ...
    function closeSessions(reason) {
        ...
        console.log("[Nova Mobile Sessions Final V1] close", reason || "unknown");
    ...
    async function newChat() {
        try {
            ...
            console.error("[Nova Mobile Sessions Final V1] new chat failed", error);
    ...
    function goToSession(id, reason) {
        ...
        location.href = "/mobile?session_id=" + encodeURIComponent(id) + "&v=sessions-final-" + encodeURIComponent(reason || "switch") + "-" + Date.now();
    }

    function sessionTitle(session) {
        return String(session.title || session.name || session.id || session.session_id || "New Chat");
    }
    ...
    async function openSessions(reason) {
        ...
        top.appendChild(button("Close", function () {
        ...
        actions.appendChild(button("New Chat", newChat));
        actions.appendChild(button("Refresh", function () {
        ...
        try {
            ...
            console.log("[Nova Mobile Sessions Final V1] open", {
            ...
            console.error("[Nova Mobile Sessions Final V1] load failed", error);
    ...
    function bindHeader() {
        ...
        header.dataset.novaMobileSessionsFinal = "1";

        if (header.dataset.novaMobileSessionsFinalBound === "1") {
            return true;
        }

        header.dataset.novaMobileSessionsFinalBound = "1";
    ...
    window.NovaMobileSessionsFinalV1 = {
        open: openSessions,
        close: closeSessions,
    ...
    console.log("[Nova Mobile Sessions Final V1] installed");
})();
