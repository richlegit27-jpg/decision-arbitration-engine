async function sendText(textOverride) {
  ...
  try {
     ...
     * NovaChatMessages.renderMessages() here.
     *
     * chat-messages.js / the normal chat rendering
     * pipeline owns DOM rendering. Calling it directly
     * here was causing the freshly rendered message
     * surface to be rewritten by the older renderer,
     * which is why the good version reverted to the
     * bad version after every send.
     */
