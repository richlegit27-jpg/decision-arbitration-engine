...
class ProjectExecutionController:
    ...
    def _phase_schedule(self, project, tasks):
        ...
        Flat projects return all existing runnable tasks unchanged.
        """
        ...
        for phase in phases:
            ...
            phase_runnable = self._runnable_tasks(
                valid_tasks
            )

            phase_runnable = [
                task
                for task in phase_runnable
                if str(
                    task.get("phase_id", "")
                ).strip() == phase_id
            ]
        ...
        # All assigned phase tasks are complete.
        return {
            "phased": True,
            "phase": None,
            "phase_tasks": [],
