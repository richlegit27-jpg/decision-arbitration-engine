...
def extract_patch_build_input(user_text: str) -> Optional[str]:
    raw = str(user_text or "").strip()
    lowered = raw.lower()

    for prefix in PATCH_BUILD_PREFIXES:
...
def build_patch_build_response(
