...
class AgentService:
    ...
    What this does:
    - scores base route from the current user request
    - applies memory-driven overrides
    - applies preference-driven response style override
    - returns one stable decision packet for chat_service/autonomy_service
    ...
    def decide(
        ...
        *,
        ...
        winning_mode, winning_score = self._pick_mode(base_mode_scores)
