    ...
    try:
        ...
        if has_attachment_context and attachment_intent:
            ...
            for line in user_text.splitlines():
                ...
                if clean.lower().startswith("typed user text"):
                    continue
            ...
            if top:
                ...
                reply = (
                    "Attachment received:\n"
                    f"Summary: The attachment appears related to: {topic}.\n\n"
                    "Topics detected:\n"
                )
                ...
                reply = (
                    "Attachment received:\n"
                    "The attachment was received but no clean text could be extracted."
                )
    ...
    if _clean_recall_probe in _conversation_recall_phrases:
        ...
        try:
            ...
            if isinstance(_active_execution_state, dict):
                _exec_status = service.safe_str(_active_execution_state.get("status")).lower()
