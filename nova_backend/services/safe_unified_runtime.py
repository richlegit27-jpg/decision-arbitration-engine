...
from nova_backend.services.graph_runtime_service import GraphRuntimeService
from nova_backend.services.observability_service import ObservabilityService
from nova_backend.services.runtime_learning_service import RuntimeLearningService
...
class SafeUnifiedRuntime:
    ...
    def _execution_summary(self, execution_state):
    ...
    def _reflect(self, execution_summary):
    ...
    def _apply_decision_to_state(self, execution_state, decision):
        execution_state = self._safe_dict(execution_state)
    ...
    def _meta_control(self, execution_summary):
        execution_summary = self._safe_dict(execution_summary)
    ...
    def get_runtime_history(self, limit=25):
        return self.runtime_history[-limit:]

    def get_recent_events(self, limit=50):
        return self.observability.recent_events(limit=limit)
...
class RuntimeBootstrap:
    ...
    def build(chat_service=None):
        return SafeUnifiedRuntime(chat_service=chat_service)