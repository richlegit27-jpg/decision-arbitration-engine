...
class SafeUnifiedRuntime:
    ...
    def _meta_control(
        ...
        complete = execution_summary.get(
            "complete",
            False,
        )
    ...
    def run_cycle(
        ...
        world_state = self._safe_dict(
            world_state
        )

        scheduler_state = self._safe_dict(
            scheduler_state
        )

        knowledge_graph = self._safe_dict(
            knowledge_graph
        )
