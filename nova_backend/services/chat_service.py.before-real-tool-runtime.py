    ...
    def _run_tool_decision(
        ...
        if tool_name == "apply_pending_fix":
            ...
            return {
                ...
                "tool_name": "apply_pending_fix",
                "result": (
                    "Apply-fix command detected. "
                    "Pending fix execution will "
                    "be handled by the execution "
                    "approval flow."
                ),
            }
