...
ARTIFACTS = [
    {"id": str(uuid.uuid4()), "title": "Demo Image", "type": "image/png", "url": "/static/demo/image1.png", "pinned": False},
    {"id": str(uuid.uuid4()), "title": "Demo PDF", "type": "application/pdf", "url": "/static/demo/sample.pdf", "pinned": True}
]
MEDIA = [
