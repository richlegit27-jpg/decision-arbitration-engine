...
.DESCRIPTION
  ...
  3. Safe to experiment â€” can rollback with phase4_checkpoint.ps1
#>
...
Write-Host "ðŸ“¦ Auto-checkpointing Nova Phase 4..."
& $BackupScript -Checkpoint

# Step 2: Stop any running Python processes
Write-Host "â›” Stopping existing Python processes..."
Get-Process python -ErrorAction SilentlyContinue | Stop-Process -Force

# Step 3: Launch backend
Write-Host "ðŸš€ Starting Nova backend on port 8743..."
