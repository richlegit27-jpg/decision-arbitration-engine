...
COMMANDS = [
    ...
    [str(ROOT / "tools" / "nova_phase_5a_stale_patch_script_review_smoke.py")],
    [str(ROOT / "tools" / "nova_phase_5c_remaining_repair_script_review_smoke.py")],
    [str(ROOT / "tools" / "nova_phase_6a_active_tool_inventory_smoke.py")],
    [str(ROOT / "tools" / "nova_phase_6b_phase_4qr_helper_review_smoke.py")],
