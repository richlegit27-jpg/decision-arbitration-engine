...
print("\n=== nova_secret_log_hygiene_smoke ===")
_nova_secret_log_smoke = Path(__file__).with_name("nova_secret_log_hygiene_smoke.py")
subprocess.run([sys.executable, str(_nova_secret_log_smoke)], check=True)
print("PASS nova_secret_log_hygiene_smoke")
