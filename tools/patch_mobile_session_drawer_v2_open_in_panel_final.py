...
marker = "NOVA_SESSION_DRAWER_V2_OPEN_IN_PANEL_FINAL_20260703"
if marker not in js:
    extra = r'''
...
app2 = re.sub(
    ...
    "nova-mobile-session-drawer-v2.js?v=20260703-open-in-panel-final",
    app,
)
...
print("patched open-in-panel final")
