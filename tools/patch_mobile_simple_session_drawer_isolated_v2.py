...
script = '<script src="/static/js/mobile/nova-mobile-simple-session-drawer-v1.js?v=simple-session-drawer-isolated-v2-20260704"></script>'
...
print("Installed isolated v2 simple session drawer script.")
