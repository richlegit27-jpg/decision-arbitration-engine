...
js_path = Path("static/js/mobile/nova-mobile-session-fallback-renderer-v1.js")
...
script_tag = '<script src="/static/js/mobile/nova-mobile-session-fallback-renderer-v1.js?v=20260703-session-fallback"></script>'

for template_name in ("templates/mobile.html", "templates/index-mobile.html"):
    ...
    if "nova-mobile-session-fallback-renderer-v1.js" in text:
        print(template_name, "already has fallback script")
        continue
