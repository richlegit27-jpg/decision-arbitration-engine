...
js_path = Path("static/js/mobile/nova-mobile-send-stable-v1.js")
...
marker = "NOVA_MOBILE_SEND_STABLE_V1_INJECT_20260703"
...
'''
    ...
    idx = app.rfind(anchor)
    if idx >= 0:
        app = app[:idx] + block + "\n" + app[idx:]
    else:
        app = app.rstrip() + block + "\n"

    app_path.write_text(app, encoding="utf-8")
    print("installed send stable injector")
else:
    print("send stable injector already installed")
