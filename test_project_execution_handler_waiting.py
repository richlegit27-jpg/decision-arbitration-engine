...
class WaitingExecutionStepService:
    def execute_step_logic(self, session_id, step):
        ...
        updated_step["result"] = "Additional information is required."
        return updated_step
...
def main():
    ...
    assert final_state["current_step"]["id"] == "analysis-waiting", final_state
    ...
    print("WAITING STATE REGRESSION TEST PASSED")
